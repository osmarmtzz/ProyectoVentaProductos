...
<head>
    ...
    <title>Pagar</title>
    <link rel="stylesheet" href="css/pagar1.css">
...
<main>
        ...
        <section class="card__front">
          ...
          <div class="card__footer">
            <div class="card__holder">
              <div class="card__section__title">Titular de la tarjetar</div>
              <div id="card_holder">Nombre de la tarjeta </div>
            </div>
            <div class="card__expires">
              <div class="card__section__title">Expiracion</div>
      ...
      <form class="form">
        ...
        <div class="filed__group">
          <div>
            <label for="expiration_month">Dia de Expiracion</label>
    ...
    <script src="js/pagar1.js"></script>
